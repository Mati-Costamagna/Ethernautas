...
def on_connect(client, userdata, flags, rc, properties=None):
    if rc == 0:
        print("Sensor Temperatura Sala 2 conectado")
...
print("Conectando Sensor Temperatura Sala 2...")
...
try:
    while True:
        if user_data['activo']:
            ...
            client.publish("lan/sala2/sensor/temp", str(temperatura), qos=1)
